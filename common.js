...
(function(){
  ...
  var P={
    ...
    'salary':{k:'Regression · Managerial Decision Making',t:'Data-Role Salary Prediction',
      f:'A multiple-regression model on a <strong>930-observation</strong> global dataset of data-role salaries, built in BUAL 5380 (Managerial Decision Making) at Lamar University. Applied <strong>backward elimination</strong> to drop weak predictors and reach a final model with <strong>R² ≈ 71%</strong>, then validated the model assumptions with a project partner and presented the findings to support salary-benchmarking decisions.',
      chips:[{b:'R² ≈ 71%',s:'final model'},{b:'930',s:'observations'},{b:'Backward elimination',s:'feature selection'}],
      links:[]},
